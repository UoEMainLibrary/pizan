...
<xsl:template match="hi[@rend='lowercase']">
<span class="hi[@rend='lowercase'"><xsl:value-of select = "translate(., 'ABCDEFGHIJKLMNOPQRSTUVWXYZaàbcdeéèfghijklmnopqrstuvwxyz', 'abcdefghijklmnopqrstuvwxyzAÀBCDEÉÈFGHIJKLMNOPQRSTUVWXYZ')" />
</span> 
</xsl:template>

<xsl:template match="hi[@rend='uppercase']">
<span class="hi[@rend='uppercase'"><xsl:value-of select = "translate(., 'ABCDEFGHIJKLMNOPQRSTUVWXYZaàbcdeéèfghijklmnopqrstuvwxyz', 'abcdefghijklmnopqrstuvwxyzAÀBCDEÉÈFGHIJKLMNOPQRSTUVWXYZ')" />
</span> 
</xsl:template>
...
<xsl:template match="fw[@place='centred']">
<span class="centred">
<xsl:apply-templates/></span>
</xsl:template>

<xsl:template match="fw[@place='inset']">
<span class="inset">
<xsl:apply-templates/></span>
</xsl:template>

<xsl:template match="fw[@place='raligned']">
<span class="raligned">
<xsl:apply-templates/></span>
</xsl:template>
...
<xsl:template match="fw[@size='smaller point']">
...
<xsl:template match="hi[@rend='smaller point']">
<span class="smaller" title="smaller text">
<xsl:apply-templates/></span>
</xsl:template>
