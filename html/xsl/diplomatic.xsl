...
<xsl:variable name="withtemp">ÀäàÇçÉÈëèéÏïöùûūüŸÿ</xsl:variable>
<xsl:variable name="sanstemp">AaaCcEEeeeIiouuuuYy</xsl:variable>
...
<xsl:template match="abbr">|<xsl:value-of select="@type"/>|<xsl:apply-templates/>
</xsl:template>
